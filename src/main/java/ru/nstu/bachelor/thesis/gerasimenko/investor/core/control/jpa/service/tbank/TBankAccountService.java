...
public class TBankAccountService {
    ...
    @Transactional
    public void activateAccount(User user, String accountName) {
    ...
    private TBankAccount getAccountByName(User user, String accountName) throws AccountNotFoundException {
