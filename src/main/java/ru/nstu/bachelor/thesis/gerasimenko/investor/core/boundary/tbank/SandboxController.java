...
@Slf4j
@RestController
@RequestMapping("api/dev/services/sandbox")
...
public class SandboxController {
    ...
    public SandboxController(HttpInteractionService httpService,
                             TBankTokenService tBankTokenService,
                             Router router) {
        this.httpService = httpService;
        this.tBankTokenService = tBankTokenService;
        this.baseUrl = router.getRouteToSandbox();
    }
    ...
    public ResponseEntity<?> post(@AuthenticationPrincipal User user,
        ...
        log.info("Received request to post sandbox service endpoint: {}", endpoint);
