...
@Slf4j
@RestController
@RequestMapping("api/dev/services/operations")
...
public class OperationsController {
    ...
    public OperationsController(HttpInteractionService httpService,
                                TBankTokenService tBankTokenService,
                                Router router) {
        this.httpService = httpService;
        this.tBankTokenService = tBankTokenService;
        this.baseUrl = router.getRouteToOperations();
    }
    ...
    public ResponseEntity<?> post(@AuthenticationPrincipal User user,
        ...
        log.info("Received request to post operations service endpoint: {}", endpoint);
