...
@Slf4j
@RestController
@RequestMapping("api/dev/services/users")
...
public class UsersController {
    ...
    public UsersController(HttpInteractionService httpService,
                           TBankTokenService tBankTokenService,
                           Router router) {
        this.httpService = httpService;
        this.tBankTokenService = tBankTokenService;
        this.baseUrl = router.getRouteToUsers();
    }
    ...
    public ResponseEntity<?> post(@AuthenticationPrincipal User user,
        ...
        log.info("Received request to post users service endpoint: {}", endpoint);
